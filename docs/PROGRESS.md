...
**Обновлено:** 10.04.2026 | **Ветка:** `iteration-7/scenario-engine` | **Коммит:** `7dd6879`
...
│  └─────────────┘ └─────────┘ └─────────┘ └───────┘ └─────────┘ │
│  ┌─────────────┐ ┌───────────────┐ ┌──────────┐ ┌──────────┐   │
│  │LogManager   │ │CredentialsRepo│ │ReplaySrc │ │Export    │   │
│  │█████ 100%   │ │█████ 100%     │ │████ 100% │ │████ 100% │   │
│  └─────────────┘ └───────────────┘ └──────────┘ └──────────┘   │
│  ┌─────────────┐ ┌───────────────┐                              │
...
| `tests/core/test_*.py` | 800+ тестов, покрытие 89–100% | ✅ Готово |
...
- **Общее покрытие:** 840+ тестов, ≥ 90% для нового кода
