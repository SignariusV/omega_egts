...
pip install -e .
        ...
        **Версия GUI:** 1.0 | **Статус:** ✅ Готово (100%)

        Графический интерфейс реализован согласно ТЗ [`docs/design/design`](docs/design/design).

        ### Быстрый старт GUI

        ```bash
        # Установить зависимости (включая PySide6)
        pip install -e ".[gui]"
        ...
        - **Вкладка "Подключение"**: управление TCP-сервером и CMW-500
        - **Вкладка "Сценарии"**: выполнение сценариев, просмотр пакетов, прогресс выполнения
        - **Вкладка "Редактор"**: создание и редактирование JSON-сценариев с подсветкой синтаксиса
        - **Вкладка "Логи"**: просмотр системных логов Python с фильтрацией
        - **Вкладка "Экспорт"**: выгрузка данных в CSV/JSON
        - **Диалог "Детали пакета"**: подробный разбор EGTS-пакетов с HEX-дампом
        - **Тёмная тема** по умолчанию
        - **Интеграция с CoreEngine** через EventBus
        ...
        📖 Подробная документация GUI: [`docs/design/design`](docs/design/design)
...
| **12. GUI** | Графический интерфейс оператора | ✅ Готово (100%) |
