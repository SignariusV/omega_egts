...
> ⚠️ **Проект на стадии проектирования.** Исходный код ещё не написан.
>
> Документация в `docs/` содержит полное техническое задание и текст ГОСТ.
...
|------|-----------|--------|
| **1. CLI MVP** | Core Engine + EventBus + FSM + CLI + ГОСТ 2015 + эмулятор CMW-500 | 🟡 В работе |
| **2. Сценарии** | Все 10 сценариев, HEX-файлы, export, CredentialsRepository | ⬜ Запланировано |
| **3. ГОСТ 2023** | Поддержка актуальной редакции | ⬜ Запланировано |
| **4. GUI** | Графический интерфейс оператора | ⬜ Запланировано |
| **5. Реальное CMW-500** | Интеграция с реальным оборудованием | ⬜ Запланировано |
