...
# Словарь кодов команд (CCD) из таблиц 32, 34, 46, 47 ГОСТ 33465-2015
COMMAND_CODES = {
    # Таблица 32 — Общие команды
    ...
    # Таблица 34 — Параметры УСВ (общие)
    ...
    0x0203: "EGTS_SET_GPRS_APN",
    0x0204: "EGTS_SET_SERVER_ADDRESS",

    # Таблица 47 — Параметры eCall (базовая услуга)
    0x020D: "EGTS_ECALL_TEST_NUMBER",
    0x0210: "EGTS_ECALL_ON",
    0x0211: "EGTS_ECALL_CRASH_SIGNAL_INTERNAL",
    0x0212: "EGTS_ECALL_CRASH_SIGNAL_EXTERNAL",
    0x0213: "EGTS_ECALL_SOS_BUTTON_TIME",
    0x0214: "EGTS_ECALL_NO_AUTOMATIC_TRIGGERING",
    0x0215: "EGTS_ASI15_TRESHOLD",
    0x0216: "EGTS_ECALL_MODE_PIN",
    0x0217: "EGTS_ECALL_CCFT",
    0x0218: "EGTS_ECALL_INVITATION_SIGNAL_DURATION",
    0x0219: "EGTS_ECALL_SEND_MSG_PERIOD",
    0x021A: "EGTS_ECALL_AL_ACK_PERIOD",
    0x021B: "EGTS_ECALL_MSD_MAX_TRANSMISSION_TIME",
    0x021D: "EGTS_ECALL_NAD_DEREGISTRATION_TIMER",
    0x021E: "EGTS_ECALL_DIAL_DURATION",
    0x021F: "EGTS_ECALL_AUTO_DIAL_ATTEMPTS",
    0x0220: "EGTS_ECALL_MANUAL_DIAL_ATTEMPTS",
    0x0221: "EGTS_ECALL_MANUAL_CAN_CANCEL",
    0x0222: "EGTS_ECALL_SMS_FALLBACK_NUMBER",
    0x0224: "EGTS_CRASH_RECORD_TIME",
    0x0225: "EGTS_CRASH_RECORD_RESOLUTION",
    0x0226: "EGTS_CRASH_PRE_RECORD_TIME",
    0x0227: "EGTS_CRASH_PRE_RECORD_RESOLUTION",
    0x0228: "EGTS_TRACK_RECORD_TIME",
    0x0229: "EGTS_TRACK_RECORD_RESOLUTION",
    0x022A: "EGTS_TRACK_PRE_RECORD_TIME",
    0x0230: "EGTS_VEHICLE_VIN",
    0x0231: "EGTS_VEHICLE_TYPE",
    0x0232: "EGTS_VEHICLE_PROPULSION_STORAGE_TYPE",

    # Таблица 34 — Параметры аппаратной части УСВ
    0x0404: "EGTS_UNIT_ID",
    0x0405: "EGTS_UNIT_IMEI",
    0x0406: "EGTS_UNIT_RS485_BAUD_RATE",
