...
|----|----------|--------|---------------------|
| KI-001 | Исходный код ещё не написан — проект на стадии проектирования | Открыто | Этап 1: CLI MVP |
...
- **EventBus**: 10 событий (было 3 в ТЗ 5.4). Ограничение «4-е событие = неправильная архитектура» снято — вместо этого контроль через принцип «каждое событие — отдельный тип, не данные».
