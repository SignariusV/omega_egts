...
|------|----------------|----------|
| `name` | ✅ | Название сценария |
| `scenario_version` | ✅ | Версия сценария (SemVer: `MAJOR.MINOR.PATCH`) |
...
Формат `scenario_version`: **MAJOR.MINOR.PATCH**

| Изменение | Что обновлять | Пример |
|-----------|---------------|--------|
| Изменён порядок шагов | `MAJOR` | `1.0.0` → `2.0.0` |
| Добавлен/удалён шаг | `MINOR` | `1.0.0` → `1.1.0` |
| Исправлен HEX-пакет, уточнено описание | `PATCH` | `1.0.0` → `1.0.1` |
